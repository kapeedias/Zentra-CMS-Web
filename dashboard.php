    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="d-flex align-items-center border-bottom pb-3">
                                        <div class="mr-3">
                                            <img src="assets/images/30x30-user.jpg" class="rounded-circle wd-35"
                                                alt="user">
                                        </div>
                                        <div class="w-100">
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <p class="text-muted text-center text-md-left mb-0 d-none d-md-block"><?php
                                                                                        // Start timer at the very beginning of the script
                                                                                        $start_time = microtime(true);
                                                                                        ?>

                    <!-- Your normal PHP / HTML content goes here -->

                    <?php
                    // End timer at the very end of the script
                    $end_time = microtime(true);

                    // Calculate the total page load time
                    $load_time = $end_time - $start_time;

                    // Display page load time in seconds with 4 decimal places
                    echo "<p>Page generated in " . number_format($load_time, 4) . " seconds.</p>";
