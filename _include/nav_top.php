        ...
        <ul class="navbar-nav">
                ...
                <div class="dropdown-menu" aria-labelledby="appsDropdown">
                    ...
                    <div class="dropdown-body">
                        <div class="d-flex align-items-center apps">
                            <a href="pages/apps/chat.php"><i data-feather="message-square" class="icon-lg"></i>
                                <p>Chat</p>
                            </a>
                            <a href="pages/apps/calendar.php"><i data-feather="calendar" class="icon-lg"></i>
                                <p>Calendar</p>
                            </a>
                            <a href="pages/email/inbox.php"><i data-feather="mail" class="icon-lg"></i>
                                <p>Email</p>
                            </a>
                            <a href="pages/general/profile.php"><i data-feather="instagram" class="icon-lg"></i>
                                <p>Profile</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                    ...
                    <div class="dropdown-body">
                        <a href="javascript:;" class="dropdown-item">
                            <div class="figure">
                                <img src="/assets/images/30x30-user.jpg" alt="userr">
                            </div>
                            <div class="content">
            ...
            <li class="nav-item dropdown nav-profile">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    <img src="https://placehold.co/500/000000/FFF/?text=<?php echo substr($_SESSION['user_name'], 0, 1); ?>&font=OpenSans"
                        alt="userr">
                </a>
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    <div class="dropdown-header d-flex flex-column align-items-center">
                        ...
                        <div class="info text-center">
                            ...
                            <p class="email text-muted mb-3"><?php echo htmlspecialchars($_SESSION['user_email']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="dropdown-body">
